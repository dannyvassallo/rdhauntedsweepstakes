...
```shell
git clone https://github.com/dannyvassallo/rdhauntedsweepstakes.git
cd rdhauntedsweepstakes
```

From the "rdhauntedsweepstakes" directory, install the gems by running the following:
```shell
bundle install
```

To fire up the server while in the "rdhauntedsweepstakes" directory use this command:
```shell
middleman s
```
...
pwd
```
It should turn up "rdhauntedsweepstakes"
